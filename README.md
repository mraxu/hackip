...
![Inbound IPs](https://img.shields.io/badge/Inbound_IPs-16.9M-red?style=flat-square) ![Outbound IPs](https://img.shields.io/badge/Outbound_IPs-2.1K-orange?style=flat-square) ![Total IPs](https://img.shields.io/badge/Total_IPs-16.9M-blue?style=flat-square) ![Last Updated](https://img.shields.io/badge/Last_Updated-2025--09--19-green?style=flat-square)

- **Inbound Blocklist**: 1,332,342 networks/IPs covering 16,913,856 individual IP addresses
- **Outbound Blocklist**: 2,093 networks/IPs covering 2,093 individual IP addresses
- **Total Coverage**: 16,915,949 individual IP addresses
...
*This README is automatically updated by the update script on 2025-09-19 04:18:26 UTC.*
